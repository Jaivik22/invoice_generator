...
// New controllers
  ...
  // ... (Previous imports, InvoiceGeneratorApp class, and other parts of _InvoiceHomePageState remain unchanged)
  ...
  pw.Widget _buildProfessionalLayout(Color themeColor, pw.MemoryImage? logoImage) {
    return pw.Column(
      ...
      children: [
        ...
        pw.Text('From:', style: pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold)),
        pw.Text(_businessName),
        pw.Text(_yourName),
        pw.Text(_businessAddress),
        pw.Text(_companyCityStateZip),
        pw.Text(_companyCountry),
        pw.SizedBox(height: 20),
        pw.Text('Bill to:', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
        pw.Text(_clientCompany),
        // pw.Text(_clientName),
        // pw.Text(_clientAddress),
        pw.Text(_clientCityStateZip),
        pw.Text(_clientCountry),
        pw.Text(_clientEmail),
        pw.SizedBox(height: 20),
        pw.Row(
          mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
          children: [
            pw.Text('Invoice Date: $_invoiceDate'),
            pw.Text('Due Date: $_dueDate'),
          ],
        ),
        pw.SizedBox(height: 20),
          ...
          children: [
            pw.Column(
              ...
              children: [
                ...
                pw.Text(_yourName, style: const pw.TextStyle(fontSize: 12)),
                pw.Text(_businessAddress, style: const pw.TextStyle(fontSize: 12)),
                pw.Text(_companyCityStateZip, style: const pw.TextStyle(fontSize: 12)),
                pw.Text(_companyCountry, style: const pw.TextStyle(fontSize: 12)),
              ],
            ),
            pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.end,
              children: [
                pw.Text('Bill to:', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                pw.Text(_clientCompany, style: const pw.TextStyle(fontSize: 14)),
                // pw.Text(_clientName, style: const pw.TextStyle(fontSize: 12)),
                // pw.Text(_clientAddress, style: const pw.TextStyle(fontSize: 12)),
                pw.Text(_clientCityStateZip, style: const pw.TextStyle(fontSize: 12)),
                pw.Text(_clientCountry, style: const pw.TextStyle(fontSize: 12)),
                pw.Text(_clientEmail, style: const pw.TextStyle(fontSize: 12)),
              ],
            ),
          ],
        ),
        pw.SizedBox(height: 10),
        pw.Text('Invoice Date: $_invoiceDate', style: const pw.TextStyle(fontSize: 12)),
        pw.Text('Due Date: $_dueDate', style: const pw.TextStyle(fontSize: 12)),
        pw.SizedBox(height: 10),
        pw.Table.fromTextArray(
          headers: ['Item', 'Total'],
          headerStyle: pw.TextStyle(fontWeight: pw.FontWeight.bold, color: PdfColor.fromInt(themeColor.value)),
